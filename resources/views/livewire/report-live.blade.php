                        ...
                        <div class="row justify-content-between align-items-center">
                            ...
                            <div class="col-6">
                                <a href="{{ route('form.export') }}"
                                    class="bg-blue-500 text-white font-medium px-3 py-2 w-fit flex items-center"
                                    style="float: right;">
                        ...
                        <div class="flex justify-between items-center my-6">
                            <div class="font-bold flex">
                                <form class="flex" wire:submit.prevent="submit">
                                    @csrf
                                    <div class="mx-2">
                                        <input type="checkbox" class="mx-2" wire:model="quartiles.{{ 'all' }}"
                                            value="All" class="quartile-checkbox">
                                        <label class="mx-2">All</label>
                                    </div>

                                    <div class="mx-2">
                                        <input type="checkbox" class="mx-2" wire:model="quartiles.{{ 'q1' }}"
                                            value="q1" class="quartile-checkbox">
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr class="border-b">
                                    @foreach ($formDatas as $formData)
                                        @if ($x == 0)
                                            <td class="px-4 py-3 whitespace-nowrap text-sm font-medium text-gray-900 bg-slate-300 border-b"
                                                colspan="3">
