                ...
                <div class="card-body">
                    <h4 class="card-title">
                        ...
                        <div class="row justify-content-between align-items-center mt-4">
                            ...
                            <div class="col-3">
                                <a href="{{ route('formattribute.export') }}" class="btn btn-primary text-white btn-sm mb-0" style="float: left;">
                                        ...
                                        <td>
                                            ...
                                            @endif
                                             @if (auth()->user()->can('submit field data'))
                                                 <button type="button" class="btn btn-success btn-xs text-white" wire:click="getFormData('{{ $report->id }}')" {{ $report->status == 0 ? '' : 'disabled' }}><i class="mdi mdi-{{ $report->status == 0 ? 'send' : 'check' }}"></i></button>
                                            @endif 
                                        </td>
                                    @endif
