                ...
                <div class="card-body">
                    <h4 class="card-title">
                        <div class="row justify-content-between align-items-center">
                            <div class="col-6">
                                {{ $editMode == true ? 'View Permissions assigned to role' : 'Assign Permissions to role' }}
                            </div>
                            <div class="col-6">
                                <a href="{{ route('admin.permissions.roles') }}"
                                    class="btn btn-primary btn-sm text-white" style="float: right;">Back</i></a>
                            </div>
                        </div>
                    </h4>
                        ...
                        <div class="form-group">
                            <div class="row mb-2">
                                ...
                                <div class="col-4 border pt-2 border-primary">
                                    <input class="form-check-input" type="checkbox" wire:model="all_permissions"
                                        wire:click="{{ $allPermissions == true ? 'selectAllPermissions' : 'deselectAllPermissions' }}"
                                        value="all-permissions" id="all-permissions">
                            ...
                            <div class="row">
                                @foreach ($permissionGroups as $groupKey => $permissionGroups)
                                    <div class="col-12 mb-2" wire:key="{{ $groupKey . 'permGroup' }}">
                                        <div class="row">
                                            <div class="col-12">
                        ...
                        <div class="mt-3 mb-2">
                            @if ($editMode)
                                {{-- <button type="submit" class="btn btn-success text-white"
                                    style="float: right; display: none;" disabled>Update</button> --}}
                            @else
