                ...
                <div class="card-body">
                    <h4 class="card-title">
                        <div class="row justify-content-between align-items-center">
                            ...
                            <div class="col-6">
                                <a href="{{ route('admin.staffs') }}" class="btn btn-primary btn-sm text-white"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" wire:model="phone" class="form-control form-control-sm"
                                        id="phone" placeholder="Enter Phone contact">
                                    @error('phone')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select wire:model="region_id" class="form-control form-control-sm text-dark"
                                        id="region_id">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select wire:model="role_id" class="form-control form-control-sm text-dark"
                                        id="role_id">
