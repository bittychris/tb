...
<html lang="en">
    ...
    <head>
        ...
        <title>USAID Afya Shirikishi</title>
      ...
      <nav id="navbar" class="navbar">
        ...
        <section id="hero" class="hero">
            ...
            <div id="hero-carousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="5000">
                ...
                <div class="carousel-item active" style="background-image: url(assets/img/hero-carousel/hero-1.jpg)">
                </div>
                <div class="carousel-item" style="background-image: url(assets/img/hero-carousel/hero-2.jpeg)">
                </div>
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="400">
            ...
            <section id="services" class="services section-bg">
                <div class="container" data-aos="fade-up">
                    ...
                    <div class="section-header">
                        <h2>Services</h2>
                        <p>We provide best services including monitoring TB treatment all over Tanzania and Family
                            planning and many other services.</p>
                    </div>
