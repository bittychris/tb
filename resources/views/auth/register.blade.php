            ...
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form class="forms-sample pt-3" method="POST" action="{{ route('register') }}" >
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-sm" id="phone" name="phone" placeholder="Enter Phone contact">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control form-control-sm text-dark" id="region_id" name="region_id">
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control form-control-sm" id="confirmed" name="confirmed" placeholder="Confirm password">
                    @error('confirmed') <small class="text-danger">{{ $message }}</small> @enderror
                </div>
                    
                <div class="mt-2">
                  <button type="submit" class="btn w-100 btn-danger text-white" style="float: right;">Save</button>
                </div>
              </form>
                </div>
              </div>
