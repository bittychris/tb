...
<head>
  ...
  <!-- plugins:css -->
  <link href="{{asset('assets/vendorss/mdi/css/materialdesignicons.min.css')}}" rel="stylesheet">
  <link href="{{asset('assets/vendorss/base/vendor.bundle.base.css')}}" rel="stylesheet">
  <!-- endinject -->
  <!-- plugin css for this page -->
  <link href="{{asset('assets/vendorss/datatables.net-bs4/dataTables.bootstrap4.css')}}" rel="stylesheet">
